<?php
    ...
    */
    ...
    require '../database/dbConnect.php'; //connect to database

    $sql = "SELECT product_name, product_description, product_price, product_image, product_inStock, product_status, product_update_date FROM wdv341_products";  //write sql command
