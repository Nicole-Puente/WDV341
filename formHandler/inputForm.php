<?php
    /*
        This page will gather the informaiton using a form. It will call the form-handler.php when the form is submitted.
    */
?>
<!DOCTYPE html>
...
<body>
    ...
    <section>
        ...
        <form id="newsletter-form" name="newsletter_form" method="post" action="inputForm-Handler.php"n>
            <p>
                <label for="first_name">First Name:</label> 
                <input type="text" name="first_name" id="first-name" /></p>
            <p>
